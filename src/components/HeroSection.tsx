...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      {/* Hero Content */}
      <div className="relative z-10 max-w-6xl mx-auto px-4 pt-[100px] sm:px-6 lg:px-8 text-center">
      <h1
    className="text-4xl md:text-6xl lg:text-7xl font-playfair font-normal uppercase tracking-wide mb-8 leading-tight"
  >
  ...
  <p
    className="text-lg md:text-xl lg:text-xl mx-auto leading-relaxed text-white/70 mb-12"
  >
    We automate your entire business journey from leads, outreach, and
    reminders that save your time and boost your revenue.
  </p>
