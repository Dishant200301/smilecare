  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'marquee-left-medium': 'marquee-left-3x 60s linear infinite',
        'marquee-left-fast': 'marquee-left-3x 60s linear infinite',
        'marquee-right-slow': 'marquee-right-3x 60s linear infinite',
        'marquee-right-medium': 'marquee-right-3x 60s linear infinite',
        'marquee-right-fast': 'marquee-right-3x 60s linear infinite',
